...
var file_blockchain_blockchainpb_blockchain_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x25, 0x0a, 0x0f, 0x41, 0x64, 0x64,
	...
	0x22, 0x42, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x68, 0x61, 0x69,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0x1a, 0x5a, 0x18, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68,
...
var file_blockchain_blockchainpb_blockchain_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_blockchain_blockchainpb_blockchain_proto_goTypes = []interface{}{
	(*Block)(nil),                 // 0: blockchain.Block
	(*AddBlockRequest)(nil),       // 1: blockchain.AddBlockRequest
	(*AddBlockResponse)(nil),      // 2: blockchain.AddBlockResponse
...
var file_blockchain_blockchainpb_blockchain_proto_depIdxs = []int32{
	0, // 0: blockchain.GetBlockChainResponse.blocks:type_name -> blockchain.Block
	1, // 1: blockchain.Blockchain.AddBlock:input_type -> blockchain.AddBlockRequest
	3, // 2: blockchain.Blockchain.GetBlockchain:input_type -> blockchain.GetBlockChainRequest
	2, // 3: blockchain.Blockchain.AddBlock:output_type -> blockchain.AddBlockResponse
